    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lot', models.ForeignKey(editable=False, help_text='Related lot.', on_delete=django.db.models.deletion.CASCADE, related_name='comments', related_query_name='comment', to='lot.Lot', verbose_name='Lot')),
            ],
            options={
